...
#     ]
# )
def test_associations_extractor():
    expected_records = [
    ...
    config = {
        "credentials": {"credentials_title": "Private App Credentials", "access_token": "pat-na1-a5dc43b4-609f-416a-90fc-2dcd4a7f9b59"},
    }
...
def test_extractor_supports_interpolation():
    config = {
        "credentials": {"credentials_title": "Private App Credentials", "access_token": "pat-na1-a5dc43b4-609f-416a-90fc-2dcd4a7f9b59"},
    }
